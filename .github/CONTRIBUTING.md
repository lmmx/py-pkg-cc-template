...
Firstly thank you for your interest in contributing to _{{ cookiecutter.hyphenated }}_!
...
Next get the latest checkout of the _{{ cookiecutter.hyphenated }}_ repository:

```sh
git clone git@github.com:{{ cookiecutter.github_username }}/{{ cookiecutter.hyphenated }}.git
```

Change into the newly created directory and **after activating your virtual environment**
install an editable version of {{ cookiecutter.hyphenated }} along with its tests requirements:
...
Thank you for considering contribution to _{{ cookiecutter.hyphenated }}_!
