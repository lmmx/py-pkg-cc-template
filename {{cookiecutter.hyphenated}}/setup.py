...
PROJECT_URLS = {
    "Documentation": "https://{{ cookiecutter.hyphenated }}.readthedocs.io/",
    "Bug Tracker": "https://github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.hyphenated }}/issues",
    "Source Code": "https://github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.hyphenated }}",
}
CLASSIFIERS = [
